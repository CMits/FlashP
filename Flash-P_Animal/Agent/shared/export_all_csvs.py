#!/usr/bin/env python3
"""
FLASH-P Light (Animal / Cattle edition) — Comprehensive CSV Export
...
NETWORKS list is populated as cattle-trait networks are created. Replace
...
#   ("Height/height_network", "Height"),
#   ("Muscle_Mass/muscle_mass_network", "Muscle Mass"),
#   ("Coat_Colour/coat_colour_network", "Coat Colour"),
NETWORKS = []
