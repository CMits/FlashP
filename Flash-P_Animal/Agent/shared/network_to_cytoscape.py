...
def export_graphml(network: dict, output_file: Path):
    ...
    for i, edge in enumerate(network['edges']):
        ...
        # v1.0 shape: evidence = [{doi, title, authors, evidence_sentence, ...}, ...]
...
6. Color legend:
   - Blue (#6495ED): GENE
   - Light Green (#90EE90): HORMONE
   - Gold (#FFD700): METABOLITE
   - Sky Blue (#87CEEB): ENVIRONMENT
   - Tomato (#FF6347): PHENOTYPE
