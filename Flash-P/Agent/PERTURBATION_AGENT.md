...
## Phase 2: Read Papers in Batches and Extract Experiments

Read papers in **batches of 5-8** via subagents, same as LITERATURE REVIEW agent.
...
- [ ] **v2.0: ALL test_ids are sequential (T001, T002, ...)**
- [ ] **v2.0: network_gene is a list, gene_modifiers is a dict, exogenous_supply is a flat dict**
- [ ] **v2.0: phenotype_node is present in EVERY perturbation entry**
- [ ] **v2.0: Schema validation passes (`python Agent/shared/validate_schema.py <file>`)**

*PERTURBATION AGENT v2.0 — Part of Flash-P v2.0*
